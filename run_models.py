...
assert os.getenv("MOLMIN_API_KEY") is not None, "Please set the MOLMIN_API_KEY environment variable"
...
molmin = MOLMIM(api_key=os.getenv("MOLMIN_API_KEY"))
...
MODELS = {"molmin": molmin, "claude": claude, "claude_scaffold": claude_scaffold, "reinvent": reinvent, "crem": crem}
